...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string[] characteristicsArray = Array.Empty<string>();
            ...
            while (dogCharacteristic == "")
            {
                ...
                if (readResult != null)
                {
                    ...
                    characteristicsArray = dogCharacteristic.Split(',');
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (string characteristic in characteristicsArray)
                    {
                        ...
                        for (int j = 5; j > -1; j--)
                        {
                            ...
                            {
                                Console.Write($"\rsearching our dog {ourAnimals[i, 3]} for {characteristic} {icon} {j.ToString()}");
                                Thread.Sleep(150);
                            }
